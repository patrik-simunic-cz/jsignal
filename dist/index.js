...
var jSignal = (function () {
    function jSignal() {
        ...
        this.dispatch = function (payload) {
            _this.listeners.forEach(function (listener) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2, listener(payload)];
            }); }); });
        };
...
exports.jSignal = jSignal;
exports.default = jSignal;
